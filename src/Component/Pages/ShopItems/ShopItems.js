        ...
        <div className="w-80 relative hoverDIv h-[26rem] duration-1000 rounded border-2 overflow-x-hidden shadow-lg overflow-y-hidden">
          ...
          <div className="px-4 py-4 mt-4 inline-block  bg-white duration-300 rounded-tl-lg rounded-tr-lg showDIv ">
            <div className="font-bold text-xl  text-blue-900 ">
              ...
              ></Rating>
              <h4> {product.name}</h4>
              <h4 className="text-base text-stone-600 mr-2 flex justify-center items-center">
                ...
                <span className="mx-2">
                    <ul className="flex items-center justify-center gap-2">
                        <p className="  px-2 inline-block border-black cursor-pointer bg-blue-900 text-white">-</p>
                        <p className="">000</p>
                        <p className="border-black px-2 inline-block  cursor-pointer bg-blue-900 text-white">+</p>
                    </ul>
                </span>
              </h4>
