...
import pregnancyCare from '../../Icons/preg-care.svg'
import './Services.css'
    ...
    return (
        <div className="bg-sky-100 container-none mx-auto	 ">
            ...
            <div className="flex justify-center items-center w-100  h-14 pb-56 pt-12">
                <button className="rounded-md bg-sky-500 text-white text-sm py-3 px-3 hover:bg-sky-400 font-poppins-font block   hover:duration-500 ease-in-out hover:mt-0 mt-4">View All Service</button>
            </div>
