...
const AboutDoctors = () => {
  return (
    ...
    <div className="container mx-4 md:mx-auto lg:mx-auto font-poppins-font my-4">
      <h6 className=" font-semibold opacity-50 tracking-[.25rem]"> DOCTORS </h6>
      ...
      <div className="grid sm:grid-cols-1  md:grid-cols-2 lg:grid-cols-3 gap-4">
       ...
       <div class="max-w-sm rounded overflow-x-hidden shadow-lg">
          <img
          ...
          <div class="px-4 py-4">
            ...
            <div class="font-bold text-base mb-2 opacity-50">Cardiology </div>
