      ...
      <div className="font-poppins-font bg-slate-900 text-white py-10">
        <div className="container mx-auto  grid md:grid-rows-12 md:grid-flow-col px-4 gap-4 ">
          ...
          <div className="md:col-span-2">
            ...
            <input class="shadow appearance-none border rounded w-72 py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="username" type="text" placeholder="Email"/>
                <br/>
            <input class="shadow appearance-none  mt-4 rounded w-72 py-2 px-3 bg-sky-500 hover:bg-sky-600 text-white leading-tight focus:outline-none focus:shadow-outline hover:cursor-pointer" id="username" type="submit" value="Sign Up"/>
          </div>
        </div>
      </div>
    </div>
